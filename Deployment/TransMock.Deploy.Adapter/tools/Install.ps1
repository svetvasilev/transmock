...
function InstallAdapter{
	...
	if($TargetDirectory)
	{
		...
		$GacUtilDir = Get-ChildItem $WinSDKDirectory -Filter "*$WinSDKFilter*" -Recurse -Directory #*NETFX 4.6 Tools*
...
if ((Test-Path $bizTalkRegistryPath) -eq $true){
	...
	switch($productVersion){
		# BizTalk 2010
		"3.9.469.0"  { InstallAdapter "2010"; break }
		# BizTalk 2013
		# "3.10.469.0" { InstallAdapter "2013"; break }
		# BizTalk 2013R2
		# "3.11.469.0" { InstallAdapter "2013R2"; break }
		# BizTalk 2016
		"3.12.774.0" { InstallAdapter "2016"; break }
		# deafult
...
{
	Write-Error "No able to find installed BizTalk Server instance!"		
}	
