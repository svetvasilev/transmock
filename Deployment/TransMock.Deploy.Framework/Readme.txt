...
**** Release notes ****
Version 1.6:
- Major rewrite of the messaging handling logic in the TestMessingClient class
- Fix of a synchronization issue that lead to deadlocks in some complex scenarios
