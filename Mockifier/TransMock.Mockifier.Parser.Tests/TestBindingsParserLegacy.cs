...
namespace TransMock.Mockifier.Parser.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class TestBindingsParserLegacy
    {
        ...
        public TestBindingsParserLegacy()
        {
        }
        ...
        [DeploymentItem(@"TestData\Verify.LegacyMockAddresses.cs.txt")]
        public void TestInlineParsing_SimpleMock_BTS2010()
        {
            ...
            using (System.IO.StreamReader sr = System.IO.File.OpenText("TestApplicationMockAddresses.cs"),
                srVerify = System.IO.File.OpenText("Verify.LegacyMockAddresses.cs.txt"))
            {
        ...
        public void TestInlineParsing_SimpleMock_Unescape_BTS2010()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.xml",
                "TestApplication.BindingInfo_parsed.xml", 
                null, "2010", true, true);
        ...
        [TestMethod]
        [DeploymentItem(@"TestData\TestApplication.BindingInfo.xml")]
        [DeploymentItem("Verify.LegacyMockAddresses.cs.txt")]
        public void TestInlineParsing_SimpleMock_MockedFileWriter_BTS2010()
        {
            ...
            //Verifying the contents of the generated class
            using (var srVerify = System.IO.File.OpenText("Verify.LegacyMockAddresses.cs.txt"))
            {
                string classVerify = srVerify.ReadToEnd();
        ...
        public void TestInlineParsing_SimpleMock_BTDFdirectives_BTS2010()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.BTDF.xml", 
                "TestApplication.BindingInfo.BTDF_parsed.xml", 
                null, "2010",
                legacyMockAddressesClass: true);
        ...
        [DeploymentItem(@"TestData\Verify.LegacyMockAddressesWithProps.cs.txt")]
        public void TestInlineParsing_WithPromotedProperties_BTS2010()
        {
            BizTalkBindingsParser parser = new BizTalkBindingsParser();

            parser.ParseBindings(
                "TestApplication.BindingInfoWithProps.xml",
            ...
            //Verifying the contents of the generated class
            using (System.IO.StreamReader sr = System.IO.File.OpenText("TestApplicationMockAddresses.cs"),
                srVerify = System.IO.File.OpenText("Verify.LegacyMockAddressesWithProps.cs.txt"))
            {
                string classContents = sr.ReadToEnd();
                string classVerify = srVerify.ReadToEnd();
        ...
        public void TestInlineParsing_WithPromotedProperties_BTDFdirectives_BTS2010()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfoWithProps.BTDF.xml",
        ...
        [DeploymentItem(@"TestData\Verify.LegacyMockAddresses.CustomURL.cs.txt")]
        public void TestInlineParsing_SimpleMock_CustomURL_BTS2010()
        {
            BizTalkBindingsParser parser = new BizTalkBindingsParser();

            parser.ParseBindings(
                "TestApplication.BindingInfo.CustomURL.xml", 
                "TestApplication.BindingInfo.CustomURL_parsed.xml", 
                null, "2010", legacyMockAddressesClass: true);
            ...
            //Verifying the contents of the generated class
            using (System.IO.StreamReader sr = System.IO.File.OpenText("TestApplicationMockAddresses.cs"),
                srVerify = System.IO.File.OpenText("Verify.LegacyMockAddresses.CustomURL.cs.txt"))
            {
                string classContents = sr.ReadToEnd();
                string classVerify = srVerify.ReadToEnd();
        ...
        public void TestInlineParsing_SimpleMock_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.xml",
                "TestApplication.BindingInfo2013_parsed.xml", 
                null, "2013", false, true);
        ...
        public void TestInlineParsing_SimpleMock_ClassOutputSpecified_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.xml",
                "TestApplication.BindingInfo2013_parsed.xml", 
                ".", "2013", legacyMockAddressesClass: true);
        ...
        public void TestInlineParsing_SimpleMock_BTDFdirectives_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.BTDF.xml",
                "TestApplication.BindingInfo2013.BTDF_parsed.xml", 
                null, "2013", false, true);
        ...
        public void TestInlineParsing_SimpleMock_CustomURL_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfo.CustomURL.xml",
                "TestApplication.BindingInfo.CustomURL_parsed.xml",
                null, "2013", legacyMockAddressesClass: true);
        ...
        public void TestInlineParsing_WithPromotedProperties_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfoWithProps.xml",
                "TestApplication.BindingInfoWithProps2013_parsed.xml", 
                null, "2013", legacyMockAddressesClass: true);
        ...
        public void TestInlineParsing_WithPromotedProperties_BTDFdirectives_BTS2013()
        {
            ...
            parser.ParseBindings(
                "TestApplication.BindingInfoWithProps.BTDF.xml",
                "TestApplication.BindingInfoWithProps2013.BTDF_parsed.xml", 
                null, "2013", legacyMockAddressesClass: true);
